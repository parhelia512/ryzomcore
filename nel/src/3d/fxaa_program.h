...
const char *a_glsl330f =
	...
	"\n"
	"layout(location = 0) uniform vec2 fxaaQualityRcpFrame;\n"
	"layout(location = 1) uniform float fxaaQualitySubpix;\n"
	"layout(location = 2) uniform float fxaaQualityEdgeThreshold;\n"
	"layout(location = 3) uniform float fxaaQualityEdgeThresholdMin;\n"
	"\n"
	"void main()\n"
	"{\n"
